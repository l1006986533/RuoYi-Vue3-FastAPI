...
from sqlalchemy import CHAR, Integer, Column, DateTime, Float, Integer, Text
...
class AiChatConfig(Base):
    ...
    chat_config_id = Column(Integer, primary_key=True, nullable=False, autoincrement=True, comment='配置主键')
